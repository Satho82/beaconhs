...
export const MODULE_FLOW_PROFILES: Record<string, FlowSubjectProfile> = {
  ...
  inspections: {
    ...
    fields: [
      ...
      { key: 'customer_contact_name', label: 'Customer contact', kind: 'text' },
      { key: 'customer_signer_name', label: 'Customer signer', kind: 'text' },
      { key: 'customer_signed_at', label: 'Customer signed at', kind: 'date' },
      { key: 'customer_signature_image', label: 'Customer signature (data URL)', kind: 'text' },
      { key: 'status', label: 'Status (raw)', kind: 'enum' },
  ...
  equipment: {
    ...
    fields: [
      ...
      // Linked-asset details (the bespoke PDF's Equipment Item panel).
      { key: 'asset_tag', label: 'Asset tag', kind: 'text' },
      { key: 'serial_number', label: 'Serial number', kind: 'text' },
      { key: 'equipment_description', label: 'Equipment description', kind: 'text' },
      { key: 'equipment_type_name', label: 'Equipment type', kind: 'text' },
      { key: 'equipment_category_name', label: 'Equipment category', kind: 'text' },
      { key: 'equipment_status_label', label: 'Equipment status', kind: 'text' },
      ...
      { key: 'opened_by_name', label: 'Opened by', kind: 'text' },
      { key: 'reported_by_name', label: 'Reported by', kind: 'text' },
      { key: 'cost', label: 'Cost', kind: 'text' },
      { key: 'opened_at', label: 'Opened at', kind: 'date' },
      { key: 'closed_at', label: 'Closed at', kind: 'date' },
      { key: 'status', label: 'Status (raw)', kind: 'enum' },
      { key: 'priority', label: 'Priority (raw)', kind: 'enum' },
      { key: 'equipment_status', label: 'Equipment status (raw)', kind: 'enum' },
      { key: 'item_id', label: 'Equipment (id)', kind: 'text' },
