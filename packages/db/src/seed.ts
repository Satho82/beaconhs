    ...
    .values([
      {
        tenantId,
        name: 'Standard JSHA',
        description: 'Task-based Job Safety Hazard Analysis with PPE and questions.',
        style: 'task_based',
        hasPPE: true,
        hasQuestions: true,
      },
      {
        tenantId,
        name: 'Quick FLRA',
        description: 'Hazard-based Field-Level Risk Assessment — minimal sections, fast to fill.',
        style: 'hazard_based',
        hasPPE: true,
        hasQuestions: false,
